<template >
  <div dir="rtl" class=" bg-darkBgColor ">
    ...
    <img class="w-[25%] absolute left-0 top-[65%] z-[0]" src="/images/sideImg.png" alt="side image 1">
    <!-- Todo sections -->
    <div class="container mx-auto px-10 relative z-[2]">
      <!-- Sections Parts -->
      <SectionsHomeNewsSection/>
      <SectionsHomeSeriesSection/>
      <SectionsHomeQstSection/>
      <SectionsHomeEventSection/>
      <SectionsHomeWhoSection/>
      <SectionsHomeStatsSection/>
    </div>
    <!-- Todo footer -->
      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex justify-around">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">من نحن</h2>
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
...
<style>
header{
  background-image: url('/public/images/bg-illustration.png');
  height: 100%;
